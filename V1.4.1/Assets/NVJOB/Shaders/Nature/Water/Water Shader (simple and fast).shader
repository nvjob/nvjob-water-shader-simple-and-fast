...
// NVJOB Water Shader - simple and fast V1.4.1 - https://github.com/nvjob/nvjob-water-shader-simple-and-fast
...
half _Shininess, _IntensityMt, _IntensityNm, _NormalmapDetailScale, _NormalmapDetailSpeed, _MicrowaveScale, _IntensityMicrowave, _IntensityRef, _MainDetailScale, _Parallax, _ParallaxScale, _SoftFactor;
