...
// NVJOB Water Shader - simple and fast V1.3 - https://github.com/nvjob/nvjob-water-shader-simple-and-fast
...
_ReverseFlow("Reverse Flow", Range(0, 2)) = 1
...
half _Shininess, _IntensityMt, _IntensityNm, _NormalmapDetailScale, _MicrowaveScale, _IntensityMicrowave, _IntensityRef, _MainDetailScale, _Parallax, _ParallaxScale, _SoftFactor;
...
uvnd.xy += half2(_WaterLocalUvNX, _WaterLocalUvNZ) * 0.3;
