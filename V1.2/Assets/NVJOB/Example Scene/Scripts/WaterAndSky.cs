...
public class WaterAndSky : MonoBehaviour
{
    ...
    [Header("Water Shader")]
    public float waterSoftFactor = 1;
    public float waterSinWaves = 0.7f;
    public float waterSinWavesSpeed = 0.7f;
    ...
    void Update()
    {
        ...
        Shader.SetGlobalFloat("_WaterLocalWaves", waterSinWaves);
        Shader.SetGlobalFloat("_WaterLocalWavesSpeed", waterSinWavesSpeed);
        ...
        Shader.SetGlobalFloat("_WaterSoftFactor", waterSoftFactor);
